    ...
    >
      ...
      {!loading && !error && projects.length === 0 && (
        <div className="text-center glass-card p-12 rounded-2xl border border-dashed border-slate-700">
          ...
          <h2 className="text-2xl font-bold text-white mb-3">Share Your First Idea</h2>
          <p className="text-slate-400 mb-6 max-w-md mx-auto">
            Have a project idea? Create it here and find developers who share your vision!
          </p>
              ...
              <div className="p-5 flex flex-col flex-1">
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <Link 
                    ...
                    className="flex-1 py-2.5 text-center text-sm bg-slate-800 text-slate-300 rounded-lg hover:bg-slate-700 transition-colors border border-white/5"
                  >
                    Edit
                  </Link>
                </div>
