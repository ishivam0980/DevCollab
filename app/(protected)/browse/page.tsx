                      ...
                      <div className="flex items-center gap-2 mb-4">
                        ...
                        {project.liveUrl && (
                          <a 
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="p-1.5 bg-slate-800 rounded-lg hover:bg-green-500/20 hover:text-green-400 transition-colors"
                            title="Live Demo"
                          >
                        ...
                        {project.figmaUrl && (
                          <a 
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="p-1.5 bg-slate-800 rounded-lg hover:bg-purple-500/20 hover:text-purple-400 transition-colors"
                            title="Figma Design"
                          >
                            <svg className="w-4 h-4 text-slate-300" fill="currentColor" viewBox="0 0 24 24">
