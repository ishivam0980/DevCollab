...
function SignInForm() {
  ...
  return (
    <motion.div 
      ...
      className="w-full max-w-md glass-card rounded-2xl p-8 shadow-2xl shadow-purple-500/10"
    >
      {/* Logo Section */}
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400 text-sm">Sign in to your DevCollab account</p>
      </div>
      ...
      <div className="space-y-3 mb-6">
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 rounded-xl text-sm font-semibold transition-all cursor-pointer hover:scale-[1.02]"
        >
        ...
        <button
          ...
          className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-[#24292F] text-white hover:bg-[#24292F]/90 rounded-xl text-sm font-semibold transition-all cursor-pointer hover:scale-[1.02]"
        >
      ...
      <div className="relative flex items-center my-6">
        ...
        <span className="px-3 text-xs text-slate-500 bg-transparent uppercase tracking-wider">or continue with email</span>
        <div className="flex-grow border-t border-white/10"></div>
      </div>
          ...
          <div className="relative group">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900/50 border border-white/10 text-white text-sm rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:border-white/30 placeholder:text-slate-600 transition-all"
              />
            </div>
          </div>
        </div>
          ...
          <div className="relative group">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-slate-900/50 border border-white/10 text-white text-sm rounded-xl pl-10 pr-10 py-3 focus:outline-none focus:border-white/30 placeholder:text-slate-600 transition-all"
              />
              <button
                type="button"
        ...
        <div className="flex justify-between items-center">
          <label className="flex items-center gap-2 cursor-pointer group">
            <input
              ...
              className="w-4 h-4 rounded border-slate-700 bg-slate-800 text-purple-500 focus:ring-0 focus:ring-offset-0 cursor-pointer"
            />
      ...
      <p className="mt-6 text-center text-sm text-slate-400">
        ...
        <Link href="/sign-up" className="text-purple-400 hover:text-purple-300 font-bold transition-colors">
          Sign up
        </Link>
      </p>
      ...
      {showForgotPassword && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center p-4 z-50" onClick={() => setShowForgotPassword(false)}>
          <motion.div
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            onClick={(e) => e.stopPropagation()}
            className="glass-card border border-white/10 rounded-2xl p-8 max-w-md w-full shadow-2xl"
          >
            ...
            <form onSubmit={handleForgotPassword} className="space-y-4">
              <input
                ...
                required
                className="w-full bg-slate-900/50 border border-white/10 text-white text-sm rounded-xl px-4 py-3 focus:outline-none focus:border-white/30 placeholder:text-slate-600"
              />
              ...
              <div className="flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 rounded-xl font-semibold text-sm bg-slate-800 text-white hover:bg-slate-700 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 py-3 rounded-xl font-semibold text-sm bg-gradient-to-r from-purple-600 to-blue-600 text-white hover:from-purple-500 hover:to-blue-500 disabled:opacity-50 transition-all cursor-pointer shadow-lg shadow-purple-500/20"
                >
